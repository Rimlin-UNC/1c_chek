...
| Роль | Права |
|---|---|
| **Оператор** | Сканирование, просмотр и проверка чеков, выгрузка в 1С |
| **Администратор** | Всё + пользователи, маппинг, настройки ФНС/1С, удаление выгруженных чеков |
...
После входа смените пароль: **Настройки → Мой профиль → Сменить пароль**.
